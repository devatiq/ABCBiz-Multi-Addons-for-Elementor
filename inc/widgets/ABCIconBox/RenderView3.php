...
<!--Single Icon Box-->
<div class="abc-ma-single-icon-box-three-area">
    <div class="abc-ma-single-icon-box-icons">
        <!--Icon-->
        <div class="abc-ma-ele-icon-box3-icon">
            <?php Icons_Manager::render_icon($settings['abc_ma_elementor_icon_box_icon'], ['aria-hidden' => 'true']); ?>
        </div><!--/ Icon-->
    </div>
    <div class="abc-ma-elementor-icon-box-contents">
